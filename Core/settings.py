...
class Core_Server_Settings:
	...
	# Allows any Root client (sibling server) to connect to your instance without prompting you for verification.
...
class Logging_Settings:
	...
	main_meta_folder_unix = f'{os.path.expanduser("~")}/.local/Root_meta'
	main_meta_folder_windows = f'{os.path.expanduser("~")}/.local/Root_meta'
